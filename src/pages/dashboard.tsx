...
import { useRoqPlatformUserProfiles, useBusinessOwnerCount, useCarCount, useCarSharingCount } from 'lib/roq';
...
function DashboardPage() {
  ...
  const carSharingStat = useCarSharingCount();
  ...
  const statResults: { title: string; result: number; change: number; isLoading: boolean }[] = [
    ...
    {
      title: 'Car Sharings',
      result: carSharingStat?.data,
      isLoading: carSharingStat.isLoading,
      change: Math.floor(Math.random() * (100 - 40 + 1) + 40),
    },
